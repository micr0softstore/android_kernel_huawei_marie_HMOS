...
// 4 函数声明
extern oal_uint16 hmac_mgmt_encap_addba_req(hmac_vap_stru *pst_vap, oal_uint8 *puc_data, dmac_ba_tx_stru *pst_tx_ba,
    oal_uint8 uc_tid);
extern oal_uint16 hmac_mgmt_encap_addba_rsp(hmac_vap_stru *pst_vap, oal_uint8 *puc_data, hmac_ba_rx_stru *pst_addba_rsp,
    oal_uint8 uc_tid, oal_uint8 uc_status);
extern oal_uint16 hmac_mgmt_encap_delba(hmac_vap_stru *pst_vap, oal_uint8 *puc_data, oal_uint8 *puc_addr,
    oal_uint8 uc_tid, mac_delba_initiator_enum_uint8 en_initiator, oal_uint8 reason);
extern oal_uint32 hmac_mgmt_rx_addba_req(hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user,
    oal_uint8 *puc_payload, oal_uint32 frame_body_len);
extern oal_uint32 hmac_mgmt_rx_addba_rsp(hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user,
    oal_uint8 *puc_payload, oal_uint32 frame_body_len);
extern oal_uint32 hmac_mgmt_rx_delba(hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user,
                                     uint8_t *puc_payload, oal_uint32 frame_body_len);
extern oal_uint32 hmac_mgmt_tx_addba_req(hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user,
    mac_action_mgmt_args_stru *pst_action_args);
extern oal_uint32 hmac_mgmt_tx_addba_rsp(hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user,
    hmac_ba_rx_stru *pst_ba_rx_info, oal_uint8 uc_tid, oal_uint8 uc_status);
extern oal_uint32 hmac_mgmt_tx_delba(hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user,
    mac_action_mgmt_args_stru *pst_action_args);
extern oal_uint32 hmac_mgmt_tx_addba_timeout(oal_void *p_arg);
extern oal_uint32 hmac_mgmt_tx_ampdu_start(hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user,
    mac_priv_req_args_stru *pst_priv_req);
extern oal_uint32 hmac_mgmt_tx_ampdu_end(hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user,
    mac_priv_req_args_stru *pst_priv_req);

#if (_PRE_WLAN_FEATURE_PMF != _PRE_PMF_NOT_SUPPORT)
extern oal_uint32 hmac_sa_query_interval_timeout(oal_void *p_arg);
extern void hmac_send_sa_query_rsp(mac_vap_stru *pst_mac_vap, uint8_t *pst_hdr, oal_bool_enum_uint8 en_is_protected);
extern oal_uint32  hmac_start_sa_query(mac_vap_stru *pst_mac_vap, hmac_user_stru *pst_hmac_user,
    oal_bool_enum_uint8 en_is_protected);
extern oal_uint32  hmac_pmf_check_err_code(mac_user_stru *pst_user_base_info, oal_bool_enum_uint8 en_is_protected,
    const oal_uint8 *puc_mac_hdr);
#endif

extern uint32_t hmac_tx_mgmt_send_event(mac_vap_stru *pst_vap, oal_netbuf_stru *pst_mgmt_frame, uint16_t us_frame_len);
extern oal_uint32 hmac_ie_proc_vht_opern_ie(mac_vap_stru *pst_mac_vap, const oal_uint8 *puc_payload,
    mac_user_stru *pst_mac_user);
extern oal_void hmac_mgmt_update_assoc_user_qos_table(oal_uint8 *puc_payload, oal_uint16 ul_msg_len,
...
extern oal_void hmac_mgmt_update_11ntxbf_cap(oal_uint8 *puc_payload, hmac_user_stru *pst_hmac_user);
#endif

#ifdef _PRE_WLAN_FEATURE_HISTREAM
extern oal_void hmac_mgmt_update_histream_info(mac_vap_stru *pst_mac_vap, hmac_user_stru *pst_hmac_user,
...
extern oal_void hmac_send_mgmt_to_host(hmac_vap_stru *pst_hmac_vap, oal_netbuf_stru *puc_buf, oal_uint16 us_len,
    oal_long l_freq);
...
extern oal_uint8 hmac_add_user_rates(hmac_user_stru *pst_hmac_user, oal_uint8 uc_rates_cnt, const oal_uint8 *puc_rates);
...
extern uint32_t hmac_proc_vht_cap_ie(mac_vap_stru *pst_mac_vap, hmac_user_stru *pst_hmac_user, uint8_t *puc_vht_cap_ie);

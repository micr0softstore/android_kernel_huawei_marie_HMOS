...
#endif
#ifdef _PRE_WLAN_FEATURE_1131K_BTCOEX
    hmac_vap_btcoex_stru             hmac_vap_btcoex;
#endif
#ifdef _PRE_WLAN_FEATURE_SAE
    oal_work_stru                    sae_report_ext_auth_worker;               /* SAE report external auth req工作队列 */
    uint8_t                          duplicate_auth_seq4_flag    : 1;
    uint8_t                          sae_resv                    : 7;
#endif
...
extern oal_uint32  hmac_vap_creat_netdev(hmac_vap_stru *pst_hmac_vap,
                                         oal_int8 *puc_netdev_name,
                                         oal_uint8 puc_netdev_name_len,
                                         const oal_int8 *puc_mac_addr);
...
extern oal_uint32 hmac_check_opmode_notify(
    ...
    hmac_user_stru                  *pst_hmac_user);
#endif
extern oal_void hmac_handle_disconnect_rsp(hmac_vap_stru *pst_hmac_vap,
                                           hmac_user_stru *pst_hmac_user,
...
extern void hmac_btcoex_arp_fail_delba(oal_netbuf_stru *netbuf, hmac_vap_stru *hmac_vap);
extern uint32_t hmac_btcoex_delba_from_user(mac_vap_stru *mac_vap, hmac_user_stru *hmac_user);

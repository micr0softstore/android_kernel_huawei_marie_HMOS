...
oal_uint32  hmac_tcp_opt_rx_get_tcp_ack(oal_netbuf_stru *skb,
                                        hmac_vap_stru *pst_hmac_vap,
                                        oal_uint16 *p_us_index,
                                        oal_uint8 dir);
oal_uint32  hmac_tcp_opt_tx_get_tcp_ack(oal_netbuf_stru *skb,
                                        hmac_vap_stru *pst_hmac_vap,
                                        oal_uint16 *p_us_index,
                                        oal_uint8 dir);
oal_uint16 hmac_tcp_opt_tcp_ack_list_filter(hmac_vap_stru *pst_hmac_vap,
...
void hmac_trans_queue_filter(hmac_vap_stru *pst_hmac_vap,

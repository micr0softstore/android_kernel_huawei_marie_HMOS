...
#define MAC_IS_ASUS_AP(bssid)            ((bssid[0] == 0x04) && (bssid[1] == 0xD4) && (bssid[2] == 0xC4))
#define MAC_IS_BELKIN_AP(bssid)          ((bssid[0] == 0x14) && (bssid[1] == 0x91) && (bssid[2] == 0x82))
#define MAC_IS_NETGEAR_WNDR_AP(bssid)    ((bssid[0] == 0x08) && (bssid[1] == 0xbd) && (bssid[2] == 0x43))
#define MAC_IS_TRENDNET_AP(bssid)        ((bssid[0] == 0xd8) && (bssid[1] == 0xeb) && (bssid[2] == 0x97))
#define MAC_IS_DLINK_AP(bssid)           ((bssid[0] == 0xcc) && (bssid[1] == 0xb2) && (bssid[2] == 0x55))
#define MAC_IS_TPINK_5640_7300_AP(bssid) ((bssid[0] == 0x94) && (bssid[1] == 0xd9) && (bssid[2] == 0xb3))
#define MAC_IS_TPINK_6500_1_AP(bssid)    ((bssid[0] == 0x0c) && (bssid[1] == 0x4b) && (bssid[2] == 0x54))
#define MAC_IS_TPINK_6500_2_AP(bssid)    ((bssid[0] == 0x48) && (bssid[1] == 0x7d) && (bssid[2] == 0x2e))
#define MAC_IS_TPINK_6500_3_AP(bssid)    ((bssid[0] == 0x14) && (bssid[1] == 0x75) && (bssid[2] == 0x90))
#define MAC_IS_TPINK_941N_AP(bssid)      ((bssid[0] == 0x50) && (bssid[1] == 0xfa) && (bssid[2] == 0x84))
#define MAC_IS_TPINK_5510_AP(bssid)      ((bssid[0] == 0x80) && (bssid[1] == 0x89) && (bssid[2] == 0x17))
#define MAC_IS_LINKSYS_EA8500_AP(bssid)  ((bssid[0] == 0xc0) && (bssid[1] == 0x56) && (bssid[2] == 0x27))
#define MAC_IS_360_AP0(bssid)            ((bssid[0] == 0xb0) && (bssid[1] == 0xd5) && (bssid[2] == 0x9d))
#define MAC_IS_360_AP1(bssid)            ((bssid[0] == 0xc8) && (bssid[1] == 0xd5) && (bssid[2] == 0xfe))
#define MAC_IS_360_AP2(bssid)            ((bssid[0] == 0x70) && (bssid[1] == 0xb0) && (bssid[2] == 0x35))
#define MAC_IS_FEIXUN_K3(bssid)          ((bssid[0] == 0x2c) && (bssid[1] == 0xb2) && (bssid[2] == 0x1a))
#define MAC_IS_LINKSYS(bssid)            ((bssid[0] == 0x60) && (bssid[1] == 0x38) && (bssid[2] == 0xe0))
#define MAC_IS_HAIER_AP(bssid)           ((bssid[0] == 0x08) && (bssid[1] == 0x10) && (bssid[2] == 0x79))
#define MAC_IS_JCG_AP(bssid)             ((bssid[0] == 0x04) && (bssid[1] == 0x5f) && (bssid[2] == 0xa7))
#define MAC_IS_FAST_AP(bssid)            ((bssid[0] == 0x44) && (bssid[1] == 0x97) && (bssid[2] == 0x5a))
#define MAC_IS_TPINK_845_AP(bssid)       ((bssid[0] == 0x88) && (bssid[1] == 0x25) && (bssid[2] == 0x93))
#define MAC_IS_WDR2041N(bssid)           ((bssid[0] == 0x88) && (bssid[1] == 0x25) && (bssid[2] == 0x93))
#define MAC_IS_NETGEAR_R2000(bssid)      ((bssid[0] == 0xb0) && (bssid[1] == 0x7f) && (bssid[2] == 0xb9))
#define MAC_IS_HORNOR_WS851(bssid)       ((bssid[0] == 0xc4) && (bssid[1] == 0xf0) && (bssid[2] == 0x81))
#define MAC_IS_FAST_FW450R(bssid)        ((bssid[0] == 0xd4) && (bssid[1] == 0x83) && (bssid[2] == 0x04))
#define MAC_IS_AX3000(bssid)             (((bssid[0] == 0x50) && (bssid[1] == 0xd4) && (bssid[2] == 0xf7)) || \
                                          ((bssid[0] == 0x48) && (bssid[1] == 0x0e) && (bssid[2] == 0xec)))
#endif

#ifdef _PRE_WLAN_FEATURE_1131K_BTCOEX
#define MAC_WLAN_CHIP_OUI_BROADCOM              0x001018
#define MAC_WLAN_CHIP_OUI_TYPE_BROADCOM         0x2
#define MAC_WLAN_CHIP_OUI_ATHEROS               0x00037f
...
#ifdef _PRE_WLAN_FEATURE_1131K_BTCOEX
    MAC_AP_TYPE_BTCOEX_BA_NO_DELETE = BIT2, /* 共存场景不删除BA，针对删BA有兼容性问题的AP */
    MAC_AP_TYPE_BTCOEX_PS_BLACKLIST = BIT3, /* 发送SELF-CTS */
    MAC_AP_TYPE_BTCOEX_DISABLE_CTS  = BIT4, /* 不回复CTS */
#endif
    MAC_AP_TYPE_BUTT
} mac_ap_type_enum;
...
typedef struct _udp_hdr_stru udp_hdr_stru;
/* frame control字段结构体 */
...
typedef struct mac_wmm_ac_params mac_wmm_ac_params_stru;
/* BSS load信息元素结构体 */
/*lint -e958*//* 屏蔽字节对齐错误 */
struct mac_bss_load
{
...
typedef struct mac_vht_sup_mcs_set mac_vht_sup_mcs_set_stru;
...
typedef struct mac_txbf_cap mac_txbf_cap_stru;
...
OAL_STATIC OAL_INLINE oal_uint8  mac_get_tid_value_4addr(const oal_uint8 *puc_header)
{
    return (puc_header[MAC_QOS_CTRL_FIELD_OFFSET_4ADDR] & 0x07); /* B0 - B2 */
}


OAL_STATIC OAL_INLINE oal_uint8  mac_get_tid_value(const oal_uint8 *puc_header, oal_bool_enum_uint8 en_is_4addr)
{
    if (en_is_4addr)
    {
        return (puc_header[MAC_QOS_CTRL_FIELD_OFFSET_4ADDR] & 0x07); /* B0 - B2 */
...
OAL_STATIC OAL_INLINE oal_uint16  mac_get_seq_num(const oal_uint8 *puc_header)
{
...
OAL_STATIC OAL_INLINE oal_uint16 mac_get_bar_start_seq_num(const oal_uint8 *puc_payload)
{
    return ((puc_payload[2] & 0xF0) >> 4) | (puc_payload[3] << 4);
}


OAL_STATIC OAL_INLINE oal_uint8  mac_get_ack_policy_4addr(const oal_uint8 *puc_header)
{
    return ((puc_header[MAC_QOS_CTRL_FIELD_OFFSET_4ADDR] & 0x60) >> 5); /* B5 - B6 */
}


OAL_STATIC OAL_INLINE oal_uint8  mac_get_ack_policy(const oal_uint8 *puc_header, oal_bool_enum_uint8 en_is_4addr)
{
    if (en_is_4addr)
    {
        return ((puc_header[MAC_QOS_CTRL_FIELD_OFFSET_4ADDR] & 0x60) >> 5); /* B5 - B6 */
...
OAL_STATIC OAL_INLINE oal_void mac_null_data_encap(oal_uint8* header, oal_uint16 us_fc, const oal_uint8 *puc_da, const oal_uint8 *puc_sa)
{
...
OAL_STATIC OAL_INLINE oal_void  mac_get_submsdu_len(const oal_uint8 *puc_submsdu_hdr, oal_uint16 *pus_submsdu_len)
{
...
OAL_STATIC OAL_INLINE oal_bool_enum_uint8 mac_is_grp_addr(const oal_uint8 *puc_addr)
{
    if ((puc_addr[0] & 1) != 0)
    {
        return OAL_TRUE;
...
OAL_STATIC OAL_INLINE oal_bool_enum_uint8  mac_ieeee80211_is_action(const oal_uint8 *puc_header)
{
    return (puc_header[0] & (MAC_IEEE80211_FCTL_FTYPE | MAC_IEEE80211_FCTL_STYPE)) == (WLAN_ACTION << 4);
}


OAL_STATIC OAL_INLINE oal_uint8  mac_get_frame_sub_type(const oal_uint8 *puc_mac_header)
{
...
OAL_STATIC OAL_INLINE oal_bool_enum_uint8  mac_get_frame_protected_flag(const oal_uint8 *puc_mac_header)
{
    return ((puc_mac_header[1] & 0x40) ? OAL_TRUE : OAL_FALSE);
}


OAL_STATIC OAL_INLINE oal_uint8  mac_frame_get_subtype_value(const oal_uint8 *puc_mac_header)
{
    return ((puc_mac_header[0] & 0xF0) >> 4) ;
}


OAL_STATIC OAL_INLINE oal_uint8  mac_get_frame_type(const oal_uint8 *puc_mac_header)
{
    return (puc_mac_header[0] & 0x0C);
}


OAL_STATIC OAL_INLINE oal_uint8  mac_frame_get_type_value(const oal_uint8 *puc_mac_header)
{
    return (puc_mac_header[0] & 0x0C) >> 2;
}


OAL_STATIC OAL_INLINE oal_uint16 mac_get_cap_info(const oal_uint8 *mac_frame_body)
{
...
OAL_STATIC OAL_INLINE oal_uint16  mac_get_auth_alg(const oal_uint8 *puc_mac_hdr)
{
...
OAL_STATIC OAL_INLINE oal_uint16  mac_get_auth_status(const oal_uint8 *puc_mac_hdr)
{
...
OAL_STATIC OAL_INLINE oal_uint16  mac_get_auth_seq_num(const oal_uint8 *puc_mac_hdr)
{
...
OAL_STATIC OAL_INLINE oal_uint8  mac_is_protectedframe(const oal_uint8 *puc_mac_hdr)
{
...
#if (_PRE_PRODUCT_ID_HI1131C_DEV ==_PRE_PRODUCT_ID)
OAL_STATIC OAL_INLINE oal_void  mac_get_address1(const oal_uint8 *puc_mac_hdr, oal_uint8 *puc_addr)
{
    oal_memcopy(puc_addr, puc_mac_hdr + 4, 6);
}
#elif (_PRE_PRODUCT_ID_HI1131C_HOST ==_PRE_PRODUCT_ID)
OAL_STATIC OAL_INLINE void mac_get_address1_host(const uint8_t *mac_hdr, uint8_t *addr, uint16_t len)
{
    int32_t ret;
    ret = memcpy_s(addr, len, mac_hdr + offsetof(mac_ieee80211_frame_stru, auc_address1), WLAN_MAC_ADDR_LEN);
    if (ret != EOK) {
        OAM_WARNING_LOG0(0, 0, "mac_get_address1_host::memcpy_s fail");
    }
}
#endif
...
#if (_PRE_PRODUCT_ID_HI1131C_DEV ==_PRE_PRODUCT_ID)
OAL_STATIC OAL_INLINE oal_void  mac_get_address2(const oal_uint8 *puc_mac_hdr, oal_uint8 *puc_addr)
{
    oal_memcopy(puc_addr, puc_mac_hdr + 10, 6);
}
#elif (_PRE_PRODUCT_ID_HI1131C_HOST ==_PRE_PRODUCT_ID)
OAL_STATIC OAL_INLINE void mac_get_address2_host(const uint8_t *mac_hdr, uint8_t *addr, uint16_t len)
{
    int32_t ret;
    ret = memcpy_s(addr, len, mac_hdr + offsetof(mac_ieee80211_frame_stru, auc_address2), WLAN_MAC_ADDR_LEN);
    if (ret != EOK) {
        OAM_WARNING_LOG0(0, 0, "mac_get_address2_host::memcpy_s fail");
    }
}
#endif
...
#if (_PRE_PRODUCT_ID_HI1131C_DEV ==_PRE_PRODUCT_ID)
OAL_STATIC OAL_INLINE oal_void  mac_get_address3(const oal_uint8 *puc_mac_hdr, oal_uint8 *puc_addr)
{
    oal_memcopy(puc_addr, puc_mac_hdr + 16, 6);
}
#elif (_PRE_PRODUCT_ID_HI1131C_HOST ==_PRE_PRODUCT_ID)
OAL_STATIC OAL_INLINE void mac_get_address3_host(const uint8_t *mac_hdr, uint8_t *addr, uint16_t len)
{
    int32_t ret;
    ret = memcpy_s(addr, len, mac_hdr + offsetof(mac_ieee80211_frame_stru, auc_address3), WLAN_MAC_ADDR_LEN);
    if (ret != EOK) {
        OAM_WARNING_LOG0(0, 0, "mac_get_address3_host::memcpy_s fail");
    }
}
#endif
...
OAL_STATIC OAL_INLINE void mac_get_qos_ctrl(oal_uint8 *puc_mac_hdr, oal_uint8 *puc_qos_ctrl)
{
    int32_t ret;
    if (OAL_TRUE != mac_is_4addr(puc_mac_hdr))
    {
        ret = memcpy_s(puc_qos_ctrl, MAC_QOS_CTL_LEN, puc_mac_hdr + MAC_QOS_CTRL_FIELD_OFFSET, MAC_QOS_CTL_LEN);
        if (ret != EOK) {
            OAM_WARNING_LOG1(0, 0, "mac_get_qos_ctrl::memcpy fail", ret);
        }
        return;
    }

    ret = memcpy_s(puc_qos_ctrl, MAC_QOS_CTL_LEN, puc_mac_hdr + MAC_QOS_CTRL_FIELD_OFFSET_4ADDR, MAC_QOS_CTL_LEN);
    if (ret != EOK) {
        OAM_WARNING_LOG1(0, 0, "mac_get_qos_ctrl::memcpy fail 4addr", ret);
    }
    return;
}
#endif
...
OAL_STATIC OAL_INLINE mac_status_code_enum_uint16  mac_get_asoc_status(const oal_uint8 *puc_mac_payload)
{
...
OAL_STATIC OAL_INLINE oal_uint16 mac_get_asoc_id(const oal_uint8 *puc_mac_payload)
{
...
OAL_STATIC OAL_INLINE oal_void mac_get_bssid(oal_uint8 *puc_mac_hdr, oal_uint8 *puc_bssid)
{
    ...
    if (mac_hdr_get_from_ds(puc_mac_hdr) == 1) {
        mac_get_address2_host(puc_mac_hdr, puc_bssid, WLAN_MAC_ADDR_LEN);
    } else if (mac_hdr_get_to_ds(puc_mac_hdr) == 1) {
        mac_get_address1_host(puc_mac_hdr, puc_bssid, WLAN_MAC_ADDR_LEN);
    } else {
        mac_get_address3_host(puc_mac_hdr, puc_bssid, WLAN_MAC_ADDR_LEN);
    }
#endif
}

...
ifeq ($(BUILD_WITH_AQ), true)
    KBUILD_CFLAGS += -DCONFIG_HARMONY_PERFORMANCE_AQ
    KBUILD_CFLAGS += -DCONFIG_OPTIMIZE_MM_AQ
    KBUILD_CFLAGS += -DCONFIG_BACKPORT_TRACE_MUTEX
    KBUILD_CFLAGS += -DCONFIG_DETECT_MMAP_SEM_AQ
    KBUILD_CFLAGS += -DCONFIG_AQ_KDUMP_GZIP
    KBUILD_CFLAGS += -DCONFIG_SCHED_HISI_AQ
ifeq (${TARGET_BUILD_VARIANT}, eng)
export TARGET_BUILD_VARIANT
    KBUILD_CFLAGS += -DCONFIG_SLUB_DEBUG_WASTE_ENG_AQ
endif
endif

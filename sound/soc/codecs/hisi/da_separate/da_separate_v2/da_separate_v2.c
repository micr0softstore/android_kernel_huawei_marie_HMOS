...
static void _pmu_codec_support_init(struct snd_soc_component *codec)
{
	struct da_separate_v2_priv *priv = snd_soc_component_get_drvdata(codec);
	struct device_node *np = codec->dev->of_node;
